...
const BookCard = ({data, favourite}) => {
  ...
  return (
    ...
    <div className=''>
        ...
        <p className='mt-2 text-zinc-100 font-semibold text-xl'> ₹ {data.price}</p>
    </div>
    </Link>
      {favourite && (
        <button className='bg-yellow-50 px-4 py-2 rounded border border-yellow-500 mt-4 text-yellow-500'
