      ...
      {AllOrders && AllOrders.length > 0 && (
        <div className='h-[100%] p-0 md:p-4 text-zinc-100'>
          ...
          <div className='mt-4 bg-zinc-800 w-full rounded py-2 px-4 flex gap-2'>
            ...
            <div className='w-[25%] md:w-[22%]'>
              <h1 className=''>
                Books
              </h1>
            </div>
            <div className=' w-[30%] md:w-[48%] hiiden md:block'>
              <h1 className=''>
                Description
              </h1>
            </div>
            ...
            <div className='bg-zinc-800 w-full rounded py-2 px-4 flex gap-2 hover:bg-zinc-900 hover:cursor-pointer transition-all duration-300'>
              ...
              <div className='w-[25%] md:w-[22%]'>
                {items.book ? (
                  ...
                  <span>No Book Available</span> // Add a fallback text when items.book is null
                )}
              </div>
              <div className='w-[30%] md:w-[48%]  md:block'>
