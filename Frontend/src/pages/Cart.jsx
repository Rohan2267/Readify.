...
const Cart = () => {
  ...
  return (
    <div className='bg-zinc-900 px-12 h-screen py-8'>
      {!Cart &&<div className='flex items-center justify-center h-[100%] '><Loader /></div>}
      {Cart && Cart.length === 0 && (
        ...
        <div className='mt-4 w-full flex items-center justify-end'>
          <div className='p-4 bg-zinc-800 rounded'>
            ...
            <div className='mt-3 flex items-center justify-between text-xl text-zinc-200'>
              <h2>
                {Cart.length} books <h2>₹ {Total}</h2>
              </h2>
            </div>
            <div className='w-[100%] mt-3'>
              <button
              className='bg-zinc-100 rounded px-4 py-2 flex justify-center w-full font-semibold hover:bg-zinc-200 text-zinc-700'
              onClick={PlaceOrder}
              >
                  Place Your Order
              </button>
